...
function Header(): React.JSX.Element {
  return <header className="border-b border-[#efe6d7] bg-white"><div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between gap-5 px-5 sm:px-8 lg:px-16">
    <Link to="/vendedor/pedidos" aria-label="Ir para o painel inicial do vendedor" className="flex items-center gap-3"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-ilarica-orange"><img src={forkKnifeIcon} alt="" className="h-6 w-6" /></span><span className="font-display text-[27px] font-extrabold text-[#7a1e1e]">Ilarica</span><span className="hidden rounded-full bg-[#fff0e8] px-2.5 py-1 text-[10px] font-bold uppercase text-ilarica-orange sm:inline">Campus Centro</span></Link>
...
function Sidebar(): React.JSX.Element {
  return <aside className="h-fit rounded-2xl bg-white p-4 lg:sticky lg:top-6 lg:w-[280px] lg:p-5"><h2 className="mb-2 font-display text-lg font-extrabold text-[#7a1e1e]">Gerenciamento</h2><nav className="flex gap-2 overflow-x-auto lg:flex-col" aria-label="Gerenciamento da cantina">
    ...
    <Link to="/vendedor/horarios" className="shrink-0 rounded-lg px-3 py-3 text-sm text-ilarica-muted hover:bg-[#fffaf2] lg:w-full">Horários</Link><Link to="/vendedor/configuracoes" className="shrink-0 rounded-lg px-3 py-3 text-sm text-ilarica-muted hover:bg-[#fffaf2] lg:w-full">Configurações</Link>
  </nav></aside>;
}
